...
abstract class CompressManagerFactory
{
    ...
    public static function create($c)
    {
        ...
        //$method =  "Mysqldump::Compress" . $c;
        switch($c)
        {
            case "Bzip2" :
                return new CompressBzip2;
                break;
            case "Gzip" :
                return new CompressGzip;
                break;
            case "None" :
                return new CompressNone;
                break;
            default :
                return new CompressNone;
                break;
...
abstract class TypeAdapterFactory
{
    public static function create($c)
    {
        ...
        //$method =  "Mysqldump::TypeAdapter" . $c;
         switch($c){
            case "Pgsql" :
                return new TypeAdapterPgsql;
            break;
            case "Dblib" :
                return new TypeAdapterDblib;
            break;
            case "Sqlite" :
                return new TypeAdapterSqlite;
            break;
            case "Mysql" :
                return new TypeAdapterMysql;
            break;
            default :
                return new TypeAdapterMysql;
            break;
