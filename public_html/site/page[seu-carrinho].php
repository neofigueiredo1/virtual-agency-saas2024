<?php $m_ecommerce->getView('controller-carrinho'); ?>
<?php $m_ecommerce->getView('controller-cupom-checkout'); ?>
<?php $m_ecommerce->getView('controller-afiliado-checkout'); ?>
...
<main>
    ...
    <section class="s_conteudo_padrao" >
        <div class="wrapper wrapper-1340 py-5 my-lg-5 my-md-4">
            <?php $m_ecommerce->getView('view-carrinho'); ?>
            <?php $m_ecommerce->getView('view-carrinho-checkout'); ?>
        </div>
    </section>
    <!-- ./Section Conteudo --> 
</main>
