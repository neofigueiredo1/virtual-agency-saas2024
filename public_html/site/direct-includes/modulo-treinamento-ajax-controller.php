...
switch($ac) {
    /**
    * Grava a resposta de uma questão do treinamento.
    */
    case 'treinamentoSaveAnswer':
       
        $treinamento_id = isset($_POST['treinamento_id']) ? (int)$_POST['treinamento_id'] : 0 ;
        ...
        try {
            $m_treinamento->respostaSalvaOpcao($treinamento_id,$questao_id,$opcao_id,$opcao_res);
